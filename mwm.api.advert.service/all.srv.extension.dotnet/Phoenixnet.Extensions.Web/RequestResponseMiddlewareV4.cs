...
{
    public class RequestResponseMiddlewareV4
    {
        private readonly RequestDelegate _next;
        private readonly ILogger<RequestResponseMiddlewareV2> _logger;
        private readonly ISerializer _serializer;

        public RequestResponseMiddlewareV4(RequestDelegate next, ILogger<RequestResponseMiddlewareV2> logger, ISerializer serializer)
        {
            _next = next;
            _logger = logger;
    ...
    public static class RequestResponseMiddlewareV4Extension
    {
        public static IApplicationBuilder UseRequestResponseMiddlewareV4(this IApplicationBuilder builder)
        {
            return builder.UseMiddleware<RequestResponseMiddlewareV4>();
        }

        public static IServiceCollection AddRequestResponseMiddlewareV4(this IServiceCollection service)
        {
            service.AddSingleton<RequestResponseMiddlewareV4>();
            return service;
        }
    } 
}
