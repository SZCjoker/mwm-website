    ...
    public class SwaggerConfig : IAbstractModule
    {
        public void Load(IServiceCollection services, IConfiguration configuration)
        {
            ...
            {   
                ...
                c.IncludeXmlComments(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "MWM.API.Site.Service.xml"));
                c.SwaggerDoc("v1", new Info { Title = "MWM.API.Site.Service", Version = "v1" });
            });
        }
    }
